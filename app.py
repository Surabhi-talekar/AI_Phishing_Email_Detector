...
def download_report():
    ...
    pdf.setFont("Helvetica-Bold", 14)
    pdf.drawString(50, y, "Threat Analysis")
    ...
    if threats:
        ...
        for threat in threats:
            ...
            pdf.drawString(70, y, "- " + threat)

            y -= 20

    else:

        pdf.drawString(70, y, "No suspicious threats detected.")
    ...
    pdf.setFont("Helvetica-Bold", 14)
    pdf.drawString(50, y, "URL Analysis")
    ...
    pdf.setFont("Helvetica-Bold", 14)
    pdf.drawString(50, y, "Attachment Analysis")
    ...
    if attachments:
        ...
        for attachment in attachments:
            ...
            pdf.drawString(70, y, "- " + attachment)

            y -= 20

    else:

        pdf.drawString(70, y, "No attachment-related keywords detected.")
    ...
    if "Safe" in session.get("prediction", ""):

        pdf.drawString(70, y, "Email appears safe.")

        y -= 20

        pdf.drawString(70, y, "Always verify unknown links before opening.")

        y -= 20

    else:

        pdf.drawString(70, y, "Do not click any links.")

        y -= 20

        pdf.drawString(70, y, "Do not download attachments.")

        y -= 20

        pdf.drawString(70, y, "Report this email to your IT/Security team.")
    ...
    pdf.drawString(50, y, "Generated by CyberShield AI")

    y -= 15

    pdf.drawString(50, y, "Developed by Surabhi Talekar")

    y -= 15

    pdf.drawString(50, y, "© 2026")
    ...
    return send_file(
        buffer,
        as_attachment=True,
        download_name="CyberShield_AI_Report.pdf",
